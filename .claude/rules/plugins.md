...
`docs/guide/claude-code-concept.md` の「agent-toolkit」セクションに各プラグインのチェック内容要約がある。
...
3. 必要なら `docs/guide/claude-code-concept.md` のチェック内容リストを更新
...
- 利用者向け説明（チェック内容・更新手順）: `docs/guide/claude-code-concept.md`
