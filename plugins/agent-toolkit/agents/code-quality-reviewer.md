...
2. 呼び出し元プロンプトから以下を確認する
   ...
   - レビュー対象外として扱う一時ファイル一覧（`.research-*.md`・`.review-spec.md`・`.review-quality.md`）
   - 出力ファイルパス（`docs/v{next}/{作業テーマ名}.review-quality.md`）
...
- 実装差分: `{BASE_SHA}`〜作業ツリー
- 対象外ファイル: `docs/v{next}/{作業テーマ名}.research-*.md`・`.review-spec.md`・`.review-quality.md`
...
````markdown
- 出力ファイル: `docs/v{next}/{作業テーマ名}.review-quality.md`
