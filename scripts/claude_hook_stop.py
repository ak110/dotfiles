...
def _main() -> int:
    ...
    # 同時発火する `agent-toolkit/scripts/stop_advisor.py` の reason が出すため、
    # 本 hook では当該章固有の指示のみを書く。
    sections = []
    if has_pyfltr:
        if project == "pyfltr":
            sections.append(
