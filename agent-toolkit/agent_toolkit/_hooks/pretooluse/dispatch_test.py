...
class TestColloquialCheck:
    ...
    def test_warns_on_deny(self, deny_substring: str):
        ...
        assert auto_message_opening_attributes(_additional_context(result)) == {
            "source": "agent-toolkit/pretooluse",
            "kind": "warn",
        }
...
class TestPlanModeSkillFirstCheck:
    ...
    def test_warns_plan_file_write_without_skill(self, tmp_path: pathlib.Path, name: str):
        ...
        assert auto_message_opening_attributes(messages) == {"source": "agent-toolkit/pretooluse", "kind": "warn"}
