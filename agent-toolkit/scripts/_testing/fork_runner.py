...
def _serve() -> None:  # pylint: disable=import-outside-toplevel
    ...
    from _agents_server import (
        state as _agents_server_state,  # noqa: F401,PLC0415 -- 同上  # pylint: disable=import-outside-toplevel
    )
    from _atk.wi import (
        process_loop_log as _process_loop_log,  # noqa: F401,PLC0415 -- 同上  # pylint: disable=import-outside-toplevel
    )
    from _common import file_lock as _file_lock  # noqa: F401,PLC0415 -- 同上  # pylint: disable=import-outside-toplevel
    from _git import status as _git_status  # noqa: F401,PLC0415 -- 同上  # pylint: disable=import-outside-toplevel
    from _hooks import (
    ...
    from _hooks import session_state as _session_state  # noqa: F401,PLC0415 -- 同上  # pylint: disable=import-outside-toplevel
    from _hooks import stop_gate as _stop_gate  # noqa: F401,PLC0415 -- 同上  # pylint: disable=import-outside-toplevel
    from _hooks import (
        tracked_model_types as _tracked_model_types,  # noqa: F401,PLC0415 -- 同上  # pylint: disable=import-outside-toplevel
    )
    from _hooks import transcript as _transcript  # noqa: F401,PLC0415 -- 同上  # pylint: disable=import-outside-toplevel
    from _plan import locations as _plan_file  # noqa: F401,PLC0415 -- 同上  # pylint: disable=import-outside-toplevel
    from _plan import structure as _plan_format  # noqa: F401,PLC0415 -- 同上  # pylint: disable=import-outside-toplevel
