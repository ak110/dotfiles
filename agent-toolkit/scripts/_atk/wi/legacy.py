...
from _atk.wi.constants import WI_TYPE_AWI, WI_TYPE_UWI
from _atk.wi.frontmatter import parse_frontmatter, serialize_frontmatter, write_entry_text
...
def _plan_legacy_migration(
    ...
    for legacy_dir in legacy_dirs:
        ...
        for path in sorted(legacy_dir.rglob("*")):
            ...
            if path.is_dir():
                if len(relative.parts) != 1 or relative.parts[0] not in WI_STATES:
