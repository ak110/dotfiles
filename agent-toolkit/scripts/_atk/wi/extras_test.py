...
from _testing.git_fakes import _FIXED_HEAD_COMMIT  # noqa: E402  # pylint: disable=wrong-import-position

# pylint: disable-next=wrong-import-position,import-error
from _testing.git_fakes import fake_git_worktree_remote_response as _fake_git_worktree_remote_response  # noqa: E402

# pylint: disable-next=wrong-import-position,import-error
from _testing.git_fakes import make_git_remote_fake as _make_git_remote_fake  # noqa: E402
...
class TestListAwiStatusRejected:
    ...
    def test_rejected_does_not_affect_uwi(
        ...
        with pytest.raises(SystemExit) as exc_info:
            atk.main(["wi", "list", "--status=rejected"], home=tmp_path)
