...
from _hooks.session_state import (  # noqa: E402  # pylint: disable=wrong-import-position,import-error
...
class TestClaimSessionTitle:
    ...
    def test_write_failure_returns_false(
        ...
        monkeypatch.setattr("_hooks.session_state._atomic_write", _fail_write)
...
class TestSweepStaleStates:
    ...
    def test_sweep_rechecks_age_after_waiting_for_update(
        ...
        original_acquire_lock = vars(sys.modules["_hooks.session_state"])["_acquire_lock"]
        ...
        monkeypatch.setattr("_hooks.session_state._acquire_lock", _acquire_lock)
