...
from _hooks.stop_gate import is_pending_async_work  # noqa: E402  # pylint: disable=wrong-import-position
from _hooks.stop_gate_test import (  # noqa: E402  # pylint: disable=wrong-import-position
...
class TestAttachmentTaskIdFallbackCompletion:
    ...
    def test_both_missing_leaves_pending_and_logs_unresolved(
        ...
        """
        monkeypatch.setattr("_hooks.stop_gate.tempfile.gettempdir", lambda: str(tmp_path))
        entries = [
            _user_async_launched_entry("toolu_a", agent_id="agent-a"),
