...
- `.chezmoi-source/dot_codex/AGENTS.md`のうち、`scripts/codex-agents-base.md`と
  `agent-toolkit/rules/*.md`を無加工連結し、生成器が128 KiB上限を検査する生成物は220行上限の対象外とする。
  手書き文書および他の生成文書には本例外を適用しない
