...
レビュー修正モードでは、採用指摘の固定7列TSV（ラウンド、重大度、指摘箇所、指摘内容、対応要否、対応内容、対応不要理由）、修正対象となる全系統表の絶対パス及び関係する全計画の絶対パスを必須入力とする。
...
採用指摘の固定7列TSV（ラウンド、重大度、指摘箇所、指摘内容、対応要否、対応内容、対応不要理由）と修正対象となる全系統表を全文読取し、関係する全計画から保持契約を読み、採用指摘だけを修正する。
