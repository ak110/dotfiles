...
レビュー修正モードでは、採用指摘の固定6列TSV（重要度、指摘箇所、指摘内容、対応要否、対応内容、対応不要理由）と関係する全計画の絶対パスを必須入力とする。
...
採用指摘の固定6列TSV（重要度、指摘箇所、指摘内容、対応要否、対応内容、対応不要理由）を読み、関係する全計画から保持契約を読み、採用指摘だけを修正する。
