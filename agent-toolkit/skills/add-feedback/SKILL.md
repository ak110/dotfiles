...
- 完成済みの通常型本文では、producerが同じ対象と技術主張について完了した調査の証拠を持つ場合に受け取る。
...
5. 新規項目は`atk mq add`で保存し、計画実装型は吸収元filenameを本文へ記録する
6. 完了表示と`atk mq show`でfilename、本文、`target_repo`、`target_commit`、`plan_file`、
   `depends_on`を入力と照合する
