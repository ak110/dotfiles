...
- 恒久成果物の文面案を執筆する前に`agent-toolkit:writing-standards`の頻出lint違反パターンを確認する
...
原文の改変を許さない逐語引用の記法は`../SKILL.md`「ユーザー入力素材の取扱い」が定める。
...
lint設定の緩和・無効化・除外指定の追加は`agent-toolkit:writing-standards`のlint緩和基準に従う。
