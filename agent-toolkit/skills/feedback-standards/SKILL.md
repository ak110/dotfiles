...
9. 保存の完了は、`atk config get private_notes`が返す作業ツリーから前項の再取得ができ、対象branchとremoteへ反映済みであることを確認して判定する。未pushのcommitが残る旨の通知を受領した場合は、`atk mq commit`でpushしてから完了とする。別の作業ツリーを作成して保存する経路は使わない。
