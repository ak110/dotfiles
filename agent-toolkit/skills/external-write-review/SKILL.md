...
本スキルは、投稿後に第三者へ届く文面を、起草者と独立した読み取り専用の担当が投稿前に検証する手順を提供する。
...
委譲先として投稿する主体も、同じ担当内の独立した照合を読み取り専用の子探索へ分ける。
...
再度結果を得られない場合は、次の経路不在と同じ扱いにする。
`start_explore`を起動できず、同等の読み取り専用委譲経路も利用できない場合は投稿を止める。
